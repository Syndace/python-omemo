...
from typing import FrozenSet, NamedTuple, Optional, Tuple, TypeVar
...
KeyExchangeTypeT = TypeVar("KeyExchangeTypeT", bound="KeyExchange")
...
class KeyExchange(ABC):
    ...
    @abstractmethod
    def builds_same_session(self, other: KeyExchangeTypeT) -> bool:
        """
        Args:
