...
class DoubleRatchet(doubleratchet.ratchets.DoubleRatchet):
    def __init__(self, root_key, own_key = None, other_enc = None, ad = None):
        ...
        dh_ratchet_config = DHRatchetConfig(RootChain(root_key), own_key = own_key, other_enc = other_enc)

        super(DoubleRatchet, self).__init__(doubleratchet.Config(double_ratchet_config, dh_ratchet_config))
